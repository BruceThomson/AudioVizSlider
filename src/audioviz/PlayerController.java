...
public class PlayerController implements Initializable {
    ...
    private void handleUpdate(double timestamp, double duration, float[] magnitudes, float[] phases) {
        ...
        ms = Double.parseDouble(oneDigit.format(ms));
        //currentText.setText(Double.toString(ms) + " ms");
         //currentText.setText(ms.toString());
        currentText.setText(oneDigit.format(ms) + " ms");
    ...
    @FXML
    private void handleDrag(ActionEvent event) {
        if (mediaPlayer != null) {
            bounds = timeSlider.lookup(".thumb").getBoundsInParent();
